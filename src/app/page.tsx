    ...
    <div className="animate-fade-in">
      ...
      <section className="grid-cards">
        ...
        >
          ...
          <p style={{ marginBottom: "1.5rem" }}>LoTE JSON endpoint for existing verifiers using static JWK based trust.</p>
          <a href="/api/lote" target="_blank" className="btn-secondary" style={{ display: 'inline-block', fontSize: '0.8rem', padding: '0.5rem 1rem', textDecoration: 'none' }}>View LoTE API</a>
        </motion.div>
